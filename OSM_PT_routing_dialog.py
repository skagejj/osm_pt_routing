...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'OSM_PT_routing_dialog_base.ui'))


class OSMroutingPTDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(OSMroutingPTDialog, self).__init__(parent)
